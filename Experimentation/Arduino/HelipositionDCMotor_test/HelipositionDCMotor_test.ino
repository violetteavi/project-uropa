 ...
 * Helicopter position motor test
 ...
 * Arduino Mega/L928N motor drive/7V battery/three 3V DC motors
 */


const int Motor1L =8;//signal IN1 pin 8
const int Motor1R =9;//signal IN2 pin 9
const int enA = 2;//for the motor enable(pin2)
const int Motor2L = 4;//signal IN1 pin4
const int Motor2R = 5; //signal IN2 pin5
const int enB = 6; // for the motor enable(pin 6)
char val =0;
...
//if the value input is equal to s, main motor runs to make it go backward
    if (val== 's'){
      //Run the backside of the motor to go backward
...
//if the value input is equal to a, side motor runs to make it turn left
      ...
      //Run the side motor to move left
...
//if the value input is equal to d,both motors run to make it turn right
      ...
      analogWrite(Motor1L,0);
      analogWrite(Motor1R,255);
      //Run the side motor to move right
